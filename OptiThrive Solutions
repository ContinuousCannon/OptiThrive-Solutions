...
<head>
  ...
  <style>
    body {
      ...
      overflow-x: hidden;
      position: relative;
      cursor: url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="%23FFD700" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/></svg>'), auto;
    }
    /* Particle Background and Side Animations */
    #particles {
      position: fixed;
      top: 0;
      left: 0;
    ...
    .wave-line {
      ...
      background: #2F4F4F;
      opacity: 0.1;
      animation: waveRight 6s infinite ease-in-out;
    }
    @keyframes waveRight {
...
<body>
  ...
  <div id="side-particles"></div>
  <div id="wave-lines"></div>

  <!-- Floating Navigation -->
  <nav>
    <div class="flex items-center pl-4">
      <img src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 260 52' width='260' height='52'%3E%3Cdefs%3E%3CradialGradient id='glowGradient' cx='50%25' cy='50%25' r='50%25'%3E%3Cstop offset='0%25' style='stop-color:%23FFD700;stop-opacity:0.3'/%3E%3Cstop offset='100%25' style='stop-color:%23FFD700;stop-opacity:0'/%3E%3C/radialGradient%3E%3C/defs%3E%3Cg transform='translate(26, 26)'%3E%3Ccircle cx='0' cy='0' r='26' fill='url(%23glowGradient)'/%3E%3Cg class='globe' transform-origin='center'%3E%3Ccircle cx='0' cy='0' r='24' fill='%231E90FF' filter='drop-shadow(2px 2px 2px rgba(0,0,0,0.3))'/%3E%3Cpath d='M-15 -5 Q-10 0 -5 -5 Q0 2 5 -5 Q10 0 15 -5 M-12 2 Q-8 8 -4 2 Q0 10 4 2 Q8 8 12 2 M-18 10 Q-14 16 -10 10 Q-6 18 0 10 Q6 18 10 10 Q14 16 18 10 M-20 20 Q-16 24 -12 20 Q-8 26 -4 20 Q0 28 4 20 Q8 26 12 20 Q16 24 20 20' fill='%2332CD32'/%3E%3C/g%3E%3Cg transform='translate(0, -12)'%3E%3Cpath d='M0 -12 V0' fill='none' stroke='%238B4513' stroke-width='3'/%3E%3Cpath d='M-8 -10 Q0 -16 8 -10 Q0 -4 -8 -10 M-10 -8 Q0 -14 10 -8 Q0 -2 -10 -8 M-12 -6 Q0 -12 12 -6 Q0 0 -12 -6' fill='%23228B22'/%3E%3C/g%3E%3C/g%3E%3Ctext x='60' y='32' font-family='Playfair Display, serif' font-size='24' font-weight='bold' fill='%231A2E2E' text-shadow='0 0 2px rgba(255,255,255,0.8)'%3EOptiThrive Solutions%3C/text%3E%3C/svg%3E" alt="OptiThrive Solutions Logo" class="logo">
    </div>
    <ul class="nav-links pr-4 flex space-x-6">
      <li><a href="#home" class="hover:text-FFD700 transition-colors">Home</a></li>
      <li><a href="#services" class="hover:text-FFD700 transition-colors">Services</a></li>
      <li><a href="#results" class="hover:text-FFD700 transition-colors">Results</a></li>
      <li><a href="#savings" class="hover:text-FFD700 transition-colors">Calculator</a></li>
      <li><a href="#contact" class="hover:text-FFD700 transition-colors">Contact</a></li>
    </ul>
  </nav>
      ...
      <div class="max-w-lg mx-auto card p-10 rounded-xl" data-aos="zoom-in" data-aos-delay="200">
        <div class="card-content">
          <span class="savings-icon mb-4 inline-block">
            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="#FFD700"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zm-1-13h2v2h-2zm0 4h2v6h-2z"/></svg>
          </span>
  ...
  <footer class="bg-2F4F4F py-8 text-center relative">
    <div class="container mx-auto px-6">
      <span class="text-xl font-bold text-FFD700 fade-in-text">OptiThrive Solutions</span>
      <p class="mt-4 text-white fade-in-text">Contact: <a href="tel:+14014511035" class="underline hover:text-FFD700">(401) 451-1035</a> | <a href="mailto:contact@optithrivesolutions.com" class="underline hover:text-FFD700">contact@optithrivesolutions.com</a></p>
  ...
  <script>
    ...
    // Side Particles (Left)
    const sideParticleContainer = document.getElementById('side-particles');
    for (let i = 0; i < 30; i++) {
      const sideParticle = document.createElement('div');
      sideParticle.classList.add('side-particle');
      sideParticle.style.left = '10px';
      sideParticle.style.top = Math.random() * 100 + 'vh';
      sideParticle.style.animationDelay = Math.random() * 5 + 's';
      sideParticleContainer.appendChild(sideParticle);
    }

    // Wave Lines (Right)
    const waveLineContainer = document.getElementById('wave-lines');
    for (let i = 0; i < 5; i++) {
      const waveLine = document.createElement('div');
      waveLine.classList.add('wave-line');
      waveLine.style.top = `${i * 20}vh`;
      waveLine.style.animationDelay = `${i * 1.2}s`;
      waveLineContainer.appendChild(waveLine);
    }
